...
const PatientAssessmentMonitor = () => {
    ...
    // Caretaker specific states removed
    ...
    // renderMap extracted for Caretaker only
    const renderContent = () => {
        switch (status) {
            case 'RUNNING':
                return (
        ...
        <div className="mx-auto max-w-3xl pb-12">
            <div className="mb-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {/* Video call initiation hidden for patient */}
                    ...
                    <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[85vh] flex flex-col">
                        ...
                        <div className="flex justify-between items-center mb-4 bg-slate-50 p-3 rounded-lg">
                            ...
                            <div className="flex gap-2">
                                <div className="flex gap-2">
                                    {/* Task addition restricted to Caretaker */}
                                </div>
                            </div>
                        </div>

                        {/* Manual task adding removed for patient */}
            ...
            {/* SOS Button removed for patient */}
        </div>
    );
};
